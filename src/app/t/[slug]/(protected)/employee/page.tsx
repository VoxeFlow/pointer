  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-5 px-4 py-5">
      <EmployeePanel
        ...
        recordsCount={user.timeRecords.length}
        lastRecordLabel={lastRecord ? buildTimelineLabel(lastRecord.recordType) : null}
        lastRecordTime={lastRecord ? formatTime(lastRecord.serverTimestamp) : null}
